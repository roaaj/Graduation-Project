...
$res = mysqli_query($conn, "SELECT * FROM books WHERE distribution='T' ORDER BY id ASC LIMIT $start_from, $limit");
// 
...
<body>
    <section class="Best">
        <div class=" title">
            <h1 class="product_text"><strong><span class="den">History</span>Books</strong></h1>
        </div>
        <div class="clear"></div>
        <?php
                ...
                <div class="overlay">
                    ...
                    <div class="infoo">
                        <div class="accordian">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3>About <?php echo ($row["AuthorName"]) ?></h3>
                                    <span class="fa fa-minus"></span>
                                </div>
                                <div class="card-body" style=" background-color:lightgray">
    ...
    <?php
    $result_db = mysqli_query($conn, "SELECT COUNT(id) FROM books  WHERE distribution='T'");
