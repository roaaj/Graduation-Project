...
$ret = mysqli_query($conn, "SELECT * FROM books WHERE classification='EnglishBook' ORDER BY id ASC LIMIT $start_from, $limit");
if (isset($_POST["add"])) {
    $id = $_GET['id'];
    $inss = mysqli_query(
        $connt8,
...
<body class="sb-nav-fixed">
    ...
    $result_db = mysqli_query($conn, "SELECT COUNT(id) FROM books WHERE  classification='EnglishBook' ");
