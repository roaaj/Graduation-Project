...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "update  books set picture='$picture' where id='$pid' ");
...
<body>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display table-responsive">
        <tbody>
            <?php
            $query = mysqli_query($con, "select BookName,picture from books where id='$pid'");
            mysqli_set_charset($con, "utf8");
            ?>
        </tbody>
    </table>
                                ...
                                <form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
                                    ...
                                    ?>
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="BookName" readonly value="<?php echo htmlentities($row['BookName']); ?>" class="span8 tip" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
