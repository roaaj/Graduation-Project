...
<head>
    ...
    <title>Manage arabi cbooks</title>
...
<body class="sb-nav-fixed">
            ...
            <main>
                ...
                while ($row = mysqli_fetch_array($x)) { ?>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Manage <?php echo $row["categoryName"]; ?></h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Manage <?php echo $row["categoryName"]; ?></li>
                        </ol>
                    <?php } ?>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $ret = mysqli_query($conn, "SELECT * FROM books WHERE category='" . $_SESSION['x'] . "'  ORDER BY id ASC LIMIT $start_from, $limit");
                                    while ($row = mysqli_fetch_array($ret)) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="managearabic-books.php?id=<?php echo $row['id']; ?>" onClick="return confirm('Do you really want to delete');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                    <?php
                                    } ?>
    ...
    for ($i = 1; $i <= $total_pages; $i++) {
        $pagLink .= "<li class='page-item'><a class='page-link' href='manageen-books.php?pid=" . $_SESSION['x'] . "&page=" . $i . "'>" . $i . "</a></li>";
    }
    echo $pagLink . "</ul>";
    ?>
