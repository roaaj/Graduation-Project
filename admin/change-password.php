...
if (isset($_POST['update'])) {
    ...
    $sql = mysqli_query($con, "SELECT password FROM adminp where password='$oldpassword'");
    $num = mysqli_fetch_array($sql);
    if ($num > 0) {
        $adminid = $_SESSION['adminid'];
        $ret = mysqli_query($con, "update adminp set password='$newpassword' where password='$oldpassword'");
